...
public class Outputter implements CommandLineRunner {
	...
	private Logger LOG = LoggerFactory.getLogger("Erwan");
    ...
    public void run(String... args) throws Exception {
        ...
        LOG.info("******************");
        LOG.info("Second user's loggin is " + tempUser.getLoggin());
        LOG.info("Second user's password is " + tempUser.getPassword());
